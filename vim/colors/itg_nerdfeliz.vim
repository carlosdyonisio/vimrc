...
" Green/Blue - #92e4c0, LightGray - #606A74, Yellow - #DDC96D, Red - #D1605E, LightGreen #B5DC64, White - #c0c0c0, BG - #282A31
...
hi Identifier	    guifg=#c0c0c0    ctermfg=254    gui=none    	cterm=none
...
hi Normal	    	guifg=#c0c0c0    ctermfg=254    guibg=#282828   ctermbg=234    	gui=none    cterm=none
hi NonText	    	guibg=#202020    ctermbg=235    guifg=#d1605e   ctermfg=167    	gui=none    cterm=none
...
hi Search			guibg=#ff0000 	 ctermbg=darkred	guifg=#ffff00	ctermfg=yellow
hi IncSearch			guibg=#ff0000 	 ctermbg=darkred	guifg=#ffff00	ctermfg=yellow
hi Statement	    guifg=#d1605e    ctermfg=167    gui=none    	cterm=none
hi Special	    	guifg=#c0c0c0    ctermfg=254    gui=none    	cterm=none
hi SpecialKey	    guifg=#9acd32    ctermfg=247    gui=none    	cterm=none
hi StatusLine	    guibg=#30323b    ctermbg=237    guifg=#c0c0c0   ctermfg=254    	gui=none    cterm=none
hi StatusLineNC	    guibg=#30323b    ctermbg=237    guifg=#c0c0c0   ctermfg=254    	gui=none    cterm=none
hi String	    	guifg=#ddc96d    ctermfg=185    gui=none    	cterm=none
hi StorageClass	    guifg=#bdb76b    ctermfg=250    gui=none    	cterm=none
hi Title	    	guifg=#c0c0c0    ctermfg=254    gui=none    	cterm=none
hi Todo	    		guifg=#ff0000    ctermfg=226    gui=none    	cterm=none
...
hi Pmenu			guibg=#30323b	 ctermbg=237	guifg=#c0c0c0	ctermfg=254		gui=none	cterm=none
